...
abstract class $ArticleCopyWith<$Res> {
  ...
  $Res call({String title, String url, String id, User user, dynamic required});
...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(title: $title, url: $url, id: $id, user: $user, required: $required)';
  }
...
abstract class _Article implements Article {
  const factory _Article(
      ...
      final dynamic required}) = _$_Article;
